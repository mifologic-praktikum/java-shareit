...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> findBookingByOwner(Long userId, BookingState state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> findBookingByUser(Long userId, BookingState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
